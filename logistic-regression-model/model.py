...
# Train classifier with imbalanced representation
def train_classifier(data):
    ...
    # Create imbalanced training set (more male resumes)
...
# Plot disparities
def plot_disparities(metric_frame, filename='fairness_plot.png'):
    ...
    plt.close()
    files.download(filename)  # Download the plot
...
def explain_predictions(model, X_test_scaled, X_test, test_gender):
    ...
    # Select 3 Hire and 2 No-Hire predictions
